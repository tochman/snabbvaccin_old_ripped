  ...
  var data = {
      ...
      tags: [
        {
          ...
          priority: 16,
          vtp_instanceDestinationId: "AW-10931633576",
          tag_id: 10,
        },
        {
        ...
        },
        {
          ...
          priority: 2,
          vtp_matchingRules:
            '["and",["contains",["variable","pageLocation",["map","stripProtocol",true]],"snabbvaccin.se"],["startsWith",["variable","pageLocation",["map","stripProtocol",true]],"www.snabbvaccin.se"]]',
          vtp_conversionLabel: "zMGpCOWsqMUDEKj7zdwo",
          vtp_instanceDestinationId: "AW-10931633576",
          tag_id: 8,
        },
        {
        ...
        {
          function: "__rep",
          vtp_containerId: "AW-10931633576",
    ...
    runtime: [
      ...
      [
        ...
        [52, "f", ["require", "internal.registerGtagCommandListener"]],
        ...
        [
          ...
          [
            ...
            [
              3,
              "h",
              [0, [15, "h"], [0, "/", [17, [15, "a"], "conversionLabel"]]],
            ],
          ],
        ],
        [52, "i", [8]],
        [52, "j", [8, "eventId", [17, [15, "a"], "gtmEventId"]]],
        [
          52,
          "k",
          [
            ...
            [
              ...
              [46, ["g", [15, "h"], "conversion", [15, "i"], [15, "j"]]],
            ],
          ],
        ],
        ["f", [15, "h"], "config", [15, "k"]],
        [
          22,
          [16, [15, "d"], "enableAdsHistoryChangeEvents"],
          [46, ["b", [15, "k"], [8, "interval", 1000]]],
        ],
        [2, [15, "a"], "gtmOnSuccess", [7]],
      ],
      [
...
*/
    ...
    zf = function (a, b, c) {
      if (Ia(a)) {
        ...
        switch (a[0]) {
          ...
          case "escape":
            d = zf(a[1], b, c);
            if (sf && Ia(a[1]) && "macro" === a[1][0] && sf.dm(a))
              return sf.Im(d);
            d = String(d);
  ...
  var Lf = {
    pl: function (a, b) {
      b[Oe.Zh] &&
        "string" === typeof a &&
        (a = 1 == b[Oe.Zh] ? a.toLowerCase() : a.toUpperCase());
  ...
  var Bh = function (a) {
    ...
    Vh = function (a, b) {
      ...
      function e(t, u) {
        ...
        var w = Uh[u];
        t.hasOwnProperty(w) &&
          (t.hasOwnProperty(u) && O(90), (v = t[w]), d(v, !0));
        return v;
      }
      function f(t, u, v) {
        var w = e(t, u);
  ...
  ni.ia = "dataLayer";
  ni.gk =
    "ChEIgNa0rAYQrInRjIf/tozMARInAOFgyNYG5FsSUyUJPanN5skybGx84/ZcpXB52g+DuKihpKxdhTStGgKvgA\x3d\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  try {
    lj = JSON.parse(
      yb(
        "eyIwIjoiU0UiLCIxIjoiU0UtTyIsIjIiOmZhbHNlLCIzIjoiZ29vZ2xlLnNlIiwiNCI6InJlZ2lvbjEiLCI1IjpmYWxzZSwiNiI6dHJ1ZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"
      )
    );
  } catch (a) {
    O(123), kj(2), (lj = {});
  ...
  aa.clearTimeout = function (a, b) {
    ...
    if (e.quiet) {
      e.quiet = !1;
      for (var g = ia(c), k = g.next(); !k.done; k = g.next())
        Gj(this, k.value);
    ...
    fm = function () {
      ...
      if ((am() || S(61)) && !a.active && Ql(b)) {
        ...
        try {
          ...
          cm(a),
            S(61) ? (fk([Q.g.K, Q.g.Ea, Q.g.O]), (Cj().active = !0)) : dm(a);
        }
      }
    };
  function cm(a) {
  ...
  var um = function (a) {
    ...
    vm = function () {
      ...
      for (
        var r = "", t = ia(Object.keys(mi)), u = t.next();
        !u.done;
        u = t.next()
      ) {
        var v = u.value;
  ...
  function Fm(a, b, c) {
    for (var d = [], e = Em(a, void 0, void 0, c), f = 0; f < e.length; f++) {
      ...
      if (!b || -1 !== b.indexOf(k)) {
        ...
        m &&
          ((m = m.split("-")),
          d.push({ id: g.join("."), Hf: 1 * m[0] || 1, Qe: 1 * m[1] || 1 }));
      }
    }
    return d;
  }
  ...
  function fo(a, b, c) {
    "a" === c.tagName.toLowerCase()
      ? eo(a, b, c)
      : "form" === c.tagName.toLowerCase() && co(a, b, c);
  }
  ...
  function to(a, b) {
    ...
    5 === c.length
      ? ((lo[a] = c.slice(0, 2).join(".")),
        (mo[a] = { id: c.slice(2, 4).join("."), Bh: Number(c[4]) || 0 }))
      : 3 === c.length
  ...
  var Gq = function (a, b) {
      ...
      a.qj &&
        (jo(c[Q.g.Wc], !!c[Q.g.X]) && (Ro(Fq, b), vo(b)),
        Oo(b),
        Uo(Fq, b),
        Cq(b, e, f));
      c[Q.g.X] &&
  ...
  var Lq = /^(www\.)?google(\.com?)?(\.[a-z]{2}t?)?$/,
    ...
    Oq = function (a) {
      ...
      return a.kn
        ? !1
        : a.Tl || a.Ul || a.Vl || a.rh || a.Kf || a.El || a.Ll
        ? !0
        : !1;
    },
    Nq = function () {
  ...
  var $q = function (a, b, c) {
    ...
    br = function (a) {
      ...
      a &&
        a.lb &&
        (b += "." + a.lb.email + "." + a.lb.phone + "." + a.lb.address);
      return b;
    },
    er = function (a) {
      if (0 != a.length) {
    ...
    lr = function () {
      ...
      for (
        ...
        var e = c[d];
        if (
          !(0 <= ir.indexOf(e.tagName.toUpperCase())) &&
  ...
  var Ir = function (a) {
    ...
    Jr = function (a) {
      return (
        a.tagName + ":" + a.isVisible + ":" + a.Z.length + ":" + nr.test(a.Z)
      );
    };
  var Kr = {
    Yk: Number("") || 500,
  ...
  function ws(a, b) {
    if (rs.test(E.location.host)) {
      ...
      return c && 2 == c.length && c[1].match(ps)
  ...
  var Ds = function () {
    ...
    Js = function (a) {
      if (
        ...
        a.h[Q.g.Ti] = a.metadata.is_gcp_conversion
          ? "www.google.com"
    ...
    Ms = function (a) {
      Hs(a, ["conversion", "remarketing"]) &&
        ...
        ("remarketing" !== a.metadata.hit_type && !S(57)) ||
          (S(60) && !ak(Q.g.O)) ||
    ...
    ht = function (a) {
      Hs(a, ["conversion"]) &&
        (a.metadata.redact_click_ids =
          !!a.metadata.redact_ads_data && !ak(Ds()));
    },
    it = function (a) {
      if (
        ...
        if (!S(60) || ak(Q.g.O)) {
          var d = c;
          if (
            rs.test(E.location.host)
              ? us.test(E.location.href) || ss.test(E.location.href)
              : !bp(d)
          ) {
            var e = zs(c);
            e && (a.h[Q.g.sb] = e);
  ...
  var lu = function (a) {
    ...
    vu = function (a, b) {
      ...
      switch (c) {
        ...
        case "user_data_lead":
          q({
            Db: "https://google.com/pagead/form-data/" + d + "?" + uu(a, b),
            format: 1,
            pb: !0,
          });
          break;
    ...
    Au = function (a) {
      zu(a, function (b) {
        for (
          var c = vu(a, b), d = c.onSuccess, e = c.Wl, f = 0;
          f < e.length;
          f++
        ) {
          var g = e[f];
  ...
  var Gu = function (a, b, c) {
    ...
    Eu = function (a, b, c, d) {
      ...
      S(89) &&
        ...
        !wi &&
        !yi &&
        hs({ url: "https://google.com/pagead/form-data/" + a, pii: b });
      Wh(b, function (g, k) {
        Cu(f, "em", g);
        Cu(f, "gtm", hn());
        pm() && Cu(f, "gcs", qm());
      ...
      event: function (a, b) {
        ...
        if (!(2 > a.length) && h(c)) {
          ...
          var q = d,
            r = q && q[Q.g.Ob];
          void 0 === r &&
            ((r = Oi(Q.g.Ob, 2)), void 0 === r && (r = "default"));
          if (h(r) || Ia(r)) {
            var t;
            b.isGtmEvent
              ? (t = h(r) ? [r] : r)
          ...
          if (C) {
            ...
            0 < C.length
              ? (g.eventModel[Q.g.Ob] = D.join())
              : delete g.eventModel[Q.g.Ob];
            $w || O(43);
            void 0 === b.noGtmEvent &&
              b.eventMetadata &&
    ...
    for (var a = !1, b; !Kx && (b = Rx()); ) {
      ...
      if (null == d) Kx = !1;
        ...
        try {
          ...
          if ("number" === typeof u) {
            for (var v = Gx[String(u)] || [], w = 0; w < v.length; w++)
              Ix.push(Tx(v[w]));
            v.length && Ix.sort(Lx);
            delete Gx[String(u)];
            u > Fx && (Fx = u);
  ...
  var Iy = ["input", "select", "textarea"],
    ...
    Ky = function (a) {
      ...
      return 0 > Iy.indexOf(b) ||
        ("input" === b && 0 <= Jy.indexOf(a.type.toLowerCase()))
        ? !1
        : !0;
    },
    Ly = function (a) {
          ...
          if (g) {
            ...
            if (k) {
              ...
              p
                ? (p.Ia &&
                    (z.clearTimeout(p.Ia),
                    p.qa.dataset.gtmFormInteractFieldId !== n && oA(p, d)),
                  (p.qa = g),
                  qA(p, d, a))
                : ((e[m] = { form: k, qa: g, bc: 0, Ia: null }),
                  qA(e[m], d, a));
            }
          }
        });
  ...
  function sA(a, b) {
    ...
    Fy("pix.fil", "init")
      ? (f = Fy("pix.fil", "reg"))
      : (nA(), (f = rA), Dy("pix.fil", "reg", rA), Dy("pix.fil", "init", !0));
    f(d, e);
  }
              ...
              if (k) {
                ...
                g &&
                  ...
                  g.hasAttribute("formaction") &&
                    ...
                    Ac(d, pc(g.getAttribute("formaction")))),
                ...
                n &&
                  (d.removeChild(n),
                  p.hasOwnProperty("action") && Ac(d, p.action),
  ...
  var LA = function (a, b) {
    ...
    KA = function (a) {
      ...
      return function (d) {
        ...
        f[e.source] = !0;
        f[d.source] = !0;
        if (!f.popstate || !f.hashchange || e.W != d.W) {
          var g = {
  ...
  var QA = function (a, b) {
    ...
    if (!d || 0 > d) d = 0;
    var e = nd(a);
    if (Fy("pix.ehl", "init", !1)) {
      var f = Fy("pix.ehl", "reg");
      f && f(d, e);
      return;
    }
    var g = function (k) {
      for (var m = 0; m < JA.length; m++) JA[m](k);
    };
    PA(g);
    OA(g);
    MA("pushState", g);
            ...
            if (k) {
              ...
              if (null !== m && null !== n) {
                ...
                p
                  ? (p.Ia &&
                      (z.clearTimeout(p.Ia),
                      p.qa.getAttribute("data-gtm-form-interact-field-id") !==
                        n && DB(p, d)),
                    (p.qa = g),
                    GB(p, d, b))
                  : ((e[m] = { form: k, qa: g, bc: 0, Ia: null }),
  ...
  function HC(a) {
    var b = !1;
    L(J(this), ["rules:!string"], arguments);
    M(this, "get_url");
    var c = JSON.parse(a);
    if (!Ia(c))
      throw Error(
    ...
    KC = function (a, b, c, d) {
      function e() {
        for (var r = 0; r < g.length; r++) {
          var t = g[r];
          t.isAborted ||
            (IC(g[r], !0), t.metadata.speculative || t.isAborted || Au(t));
        }
      }
  ...
  function kE() {
    ...
    M(this, "read_container_data"),
      a.set("containerId", "AW-10931633576"),
      a.set("version", "1"),
  ...
  var SF = window,
    ...
    UF = function (a) {
      ...
      for (
        var d = Am("AMP_TOKEN", String(TF.cookie), !0), e = 0;
        e < d.length;
        e++
      )
  ...
  function SG(a, b) {
    var c = this;
    L(J(this), ["destinationId:!string", "callback:!Fn"], arguments),
      Ip(a, function (d) {
      ...
      (function (a) {
        ...
        d
          ? (H(a.vtp_gtmOnSuccess),
            eq(b, d),
            a.vtp_remoteConfig && jq(b, a.vtp_remoteConfig || {}))
          : H(a.vtp_gtmOnFailure);
      });
    })();
  ...
  (function (a) {
    ...
    try {
      ...
      if (ik().canonical[a]) {
        ...
        if (S(33) && !Ai) {
          for (
            var T = lj["7"], ja = T ? T.split("|") : [], ha = {}, da = 0;
            da < ja.length;
            da++
          )
            ha[ja[da]] = !0;
